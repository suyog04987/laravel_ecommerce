    ...
    <div class="container">
        ...
        <form action="{{ url('add_product') }}" method="POST"   enctype="multipart/form-data" style="max-width: 500px; margin: auto;">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-control" style="color: black;" >
            </div>

            <div class="form-group">
                <label for="description">Description:</label>
                <input type="text" name="description" id="description" class="form-control" style="color: black;" rows="4" >
            </div>

            <div class="form-group">
                <label for="price">Price:</label>
                <input type="number" name="price" id="price" class="form-control" style="color: black;" >
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="quantity" id="quantity" class="form-control" style="color: black;" >
            </div>
